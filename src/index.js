...
var instanceOf = function (x, y) { return !!Q(function () { return x instanceof y; }); };
var isIn = function (x, y) { return !!Q(function () { return x in y; }); };
var isString = function (x) { return typeof x === 'string' || instanceOf(x, String); };
var isBoolean = function (x) { return typeof x === 'boolean' || instanceOf(x, Boolean); };
...
var CookieChangeEvent = /** @class */ (function (_super) {
    ...
    function CookieChangeEvent(type, eventInitDict) {
        if (eventInitDict === void 0) { eventInitDict = { changed: [], deleted: [] }; }
        var _a, _b;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    ...
                    case 2:
                        if (_r) {
                            deleted.push(__assign(__assign({}, item), { value: undefined }));
                        }
                        else {
                            changed.push(item);
                        }
                        event_1 = new CookieChangeEvent('change', { changed: changed, deleted: deleted });
    ...
    CookieStore.prototype.getAll = function (init) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, cookies.filter(function (cookie) { return cookie.name === name; })];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                _loop_1 = function (subscription) {
                    ...
                    if (currentSubcriptions.some(function (x) { return x.name === name_1 && x.url === url; }))
                        return "continue";
